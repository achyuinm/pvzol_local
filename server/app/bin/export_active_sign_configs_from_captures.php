...
/**
 * Export editable JSON configs for the "sign/active reward" system by decoding captured AMF responses.
 *
 * Covers:
 ...
 *
 * Usage:
 *   C:\php\php.exe server/game_root/server/app/bin/export_active_sign_configs_from_captures.php
 */
...
$jobs = [
    [
        'cap' => $root . '/file/real_amf/pure/api.active.getSignInfo.rsp.latest.amf',
        'out' => $outDir . '/api.active.getSignInfo.json',
    ],
    [
        'cap' => $root . '/file/real_amf/pure/api.active.sign.rsp.latest.amf',
        'out' => $outDir . '/api.active.sign.json',
    ],
];
